...
if (ToolBar_Supported)
{
	...
	HTMLStr =
                "<DIV ID='idToolbar'     STYLE='background-color:#C0C0C0;width:100%'>" +
	    	"<DIV ID='idRow1'        STYLE='position:relative;height:45;'>" +
	  	"<DIV ID='idICPBanner'   STYLE='position:absolute;top:20;left:0;height:85;width:450;overflow:hidden;vertical-align:top;'><!--BEG_ICP_BANNER--><!--END_ICP_BANNER--></DIV>" +
		"<DIV ID='idMSMenuCurve' STYLE='position:absolute;top:5;left:250;height:20;width:305;overflow:hidden;vertical-align:top;'><IMG SRC='image/bg7.gif' BORDER=0></DIV>" +
		"<DIV ID='idMSMenuPane'  STYLE='position:absolute;top:25;left:250;height:20;width:10;background-color:black;float:right;' NOWRAP><!--MS_MENU_TITLES--></DIV>" +
		"</DIV>" +
		"<DIV ID='idRow2' STYLE='position:relative;left:250;height:60;'>" +
	  	"<DIV ID='idADSBanner'   STYLE='position:absolute;top:0;left:0;height:60;width:312;vertical-align:top;overflow:hidden;'><IMG SRC='image/icons1.gif' BORDER=0 USEMAP='#icons1'></DIV>" +
	  	"<DIV ID='idMSCBanner'   STYLE='position:absolute;top:60;left:200;height:40;width:112;vertical-align:top;overflow:hidden;' ALIGN=RIGHT></DIV>" +
		"</DIV>" +
...
function drawToolbar()
{
	...
	ToolbarMinWidth = (450+18) + MSMenuWidth;
...
function resizeToolbar()
{
	...
	idMSMenuCurve.style.left  = (450+w);
	idMSMenuPane.style.left   = (450+w+18);
	idMSMenuPane.style.width  = MSMenuWidth;

	idADSBanner.style.left    = (200+w+18);
